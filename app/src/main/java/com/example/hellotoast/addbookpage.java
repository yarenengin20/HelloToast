...
import com.example.hellotoast.BookAdapter;
import com.example.hellotoast.BookInfo;
...
public class addbookpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addbookpage);
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(addbookpage.this);
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        BookAdapter adapter = new BookAdapter(bookInfoArrayList, addbookpage.this);

                        // below line is use to add linear layout
                        // manager for our recycler view.
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(addbookpage.this, RecyclerView.VERTICAL, false);
                    ...
                    Toast.makeText(addbookpage.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(addbookpage.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
